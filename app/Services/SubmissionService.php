...
class SubmissionService implements SubmissionServiceInterface
{
    ...
    protected SubmissionAnswerModel $submissionAnswerModel;
    ...
    public function __construct(
        ...
        SubmissionAnswerModel $submissionAnswerModel,
        QuestionServiceInterface $questionService,
        QuestionnaireServiceInterface $questionServiceInterface
    ) {
        $this->submissionModel = $submissionModel;
        $this->submissionAnswerModel = $submissionAnswerModel;
        $this->questionService = $questionService;
        $this->questionnaireService = $questionServiceInterface;
    }
